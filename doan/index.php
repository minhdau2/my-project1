...
<html lang="en">
  ...
  <body class="bg-gray-50 overflow-x-hidden">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <section class="bg-white rounded-2xl shadow-md p-8 mb-8 scroll-animate">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div class="space-y-4">
            <h3 class="text-3xl font-bold text-purple-700">Giới thiệu về CinemaBooking</h3>
            <p class="text-gray-700 leading-relaxed">
              <strong>CinemaBooking</strong> là hệ thống đặt vé xem phim trực tuyến giúp bạn dễ dàng chọn phim, rạp chiếu, chỗ ngồi và thanh toán chỉ trong vài bước.
              Chúng tôi mang đến trải nghiệm đặt vé nhanh chóng, tiện lợi và bảo mật tuyệt đối.
            </p>
            <ul class="list-disc list-inside text-gray-600">
              <li>Đặt vé mọi lúc, mọi nơi</li>
              <li>Thanh toán an toàn, đa dạng hình thức</li>
              <li>Cập nhật lịch chiếu liên tục theo thời gian thực</li>
              <li>Tích điểm và nhận ưu đãi hấp dẫn</li>
            </ul>
            <a href="movies.php" class="inline-block mt-4 bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors">
               Bắt đầu đặt vé ngay
            </a>
          </div>
          <div class="flex justify-center">
            <img src="img/anhnenbanner.png" alt="Giới thiệu CinemaBooking"
                 class="w-full max-w-md rounded-xl shadow-md hover:scale-105 transition-transform duration-500">
          </div>
        </div>
      </section>
      <div class="mb-8 scroll-animate">
        <h3 class="text-2xl font-bold mb-6 scroll-animate-left">Phim Đang Chiếu</h3>
          ...
          <?php
            ...
            if ($result && $result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                ...
                echo '  <a href="booking.php?movie_id=' . $row["id"] . '" class="block h-48 overflow-hidden transition duration-700 ease-in-out">';
                if (!empty($row["poster"])) {
                ...
                echo '  </a>';
                echo '  <div class="p-4">';
                echo '    <a href="booking.php?movie_id=' . $row["id"] . '" class="font-bold text-lg mb-2 block text-gray-800 hover:text-purple-600 transition-colors">';
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 scroll-animate">
        <div class="bg-white p-6 rounded-xl shadow-md text-center scroll-animate-left">
          <div class="text-3xl font-bold text-purple-600 mb-2">6</div>
          <div class="text-gray-600">Phim Đang Chiếu</div>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-md text-center scroll-animate">
          <div class="text-3xl font-bold text-purple-600 mb-2">50K+</div>
          <div class="text-gray-600">Khách Hàng Hài Lòng</div>
        </div>
        <div class="bg-white p-6 rounded-xl shadow-md text-center scroll-animate-right">
    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
            <h3 class="text-xl font-bold text-white mb-4">🎬 CinemaBooking</h3>
            <p class="text-gray-400 leading-relaxed">
                Hệ thống đặt vé xem phim trực tuyến nhanh chóng – tiện lợi – bảo mật.
            </p>
        ...
        <div>
            <h3 class="text-xl font-semibold text-white mb-4">Điều khoản sử dụng</h3>
            <ul class="space-y-2">
                <li><a href="term.php" class="hover:text-white transition">Điều Khoản Chung</a></li>
                <li><a href="transaction-terms.php"class="hover:text-white transition">Điều Khoản Giao Dịch</a></li>
                <li><a href="payment-policy.php" class="hover:text-white transition">Chính Sách Giao Dịch</a></li>
                <li><a href="privacy-policy.php" class="hover:text-white transition">Chính Sách Bảo Mật</a></li>
                <li><a href="faq.php" class="hover:text-white transition">Câu Hỏi Thường Gặp</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2">
                <li class="flex items-center gap-2">
                    <span class="text-purple-400">📍</span> Nguyễn Văn Cừ, Ninh Kiểu, TP.Cần Thơ
                </li>
                <li class="flex items-center gap-2">
                    <span class="text-purple-400">📞</span> 0123 456 789
                </li>
                <li class="flex items-center gap-2">
                    <span class="text-purple-400">📧</span> support@cinemabooking.vn
                </li>
            </ul>
 
            <div class="flex items-center gap-4 mt-4">
                
                <a href="https://www.facebook.com/hien.ly.448665" class="transition duration-300 hover:opacity-75">
                    <img src="img/facebook.png" alt="Facebook" class="w-8 h-8 rounded-lg"/>
                </a>
                
                <a href="https://www.youtube.com/channel/UCheARmYBH_GLVlDljLHBSmA" class="transition duration-300 hover:opacity-75">
                    <img src="img/youtube.png" alt="YouTube" class="w-8 h-8 rounded-lg"/>
                </a>
                
                <a href="https://www.instagram.com/lhinne_/" class="transition duration-300 hover:opacity-75">
                    <img src="img/instagram.jfif" alt="Instagram" class="w-8 h-8 rounded-lg"/>
                </a>
                
                <a href="https://zalo.me/0346468252" class="transition duration-300 hover:opacity-75">
                    <img src="img/zalo.png" alt="Zalo" class="w-8 h-8 rounded-lg"/>
                </a>
    ...
    <div class="bg-gray-800 text-center py-4 text-gray-400 text-sm">
        Phát triển bởi <span class="text-purple-400 font-medium">CinemaBooking Team</span>
    </div>
</footer>
<script>
